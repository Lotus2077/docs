...
<CardGroup cols={2}>
    ...
    <Card title="One-stop Shop for Enterprise AI" icon="sd-card">
        Dedicated 16GB RAM for AI applications and 4TB SSD for RAG data storage
    </Card>
...
<Tabs>
    <Tab title="AI Applications First">
        - 16GB dedicated RAM for AI applications
    ...
    <Tab title="Maximum Compatibility">
        ...
        - Will be recognized as a network device
...
<Tabs>
    <Tab title="Deployment Cost">
        - One-click deployment with 0 cost
