...
<CardGroup cols={3}>
<Card title="系统架构" icon="microchip" href="#关于-cfexpress-type-b-存储卡">
    了解推理模组、应用模组和管理芯片的协同工作机制
</Card>
<Card title="网络配置" icon="network-wired" href="#如何通过主机为-rm-01-提供互联网访问以-macos-为例">
    配置网络连接，实现设备与主机的数据交互
</Card>
<Card title="模型部署" icon="brain" href="#关于模型">
    掌握 AI 模型的部署、配置和优化方法
</Card>
</CardGroup>
